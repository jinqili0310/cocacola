var icon_img = 'https://s1.ax1x.com/2020/08/27/dfIX6I.jpg';
...
function createQuestions() {
	...
	prescripted_questions[5] = new Question([ " I can't understand your question. I am still learning and our programmers are working hard to improve my artificial intelligence technology. Can you type your question again, but in a simpler form? 🥺", "img/200.gif"], "What products do you have?", 6);
	...
	prescripted_questions[8] = new Question(["Sorry to hear that you are feeling blue. I hope something wonderful would happen to you soon! Remember, bad things will pass ❤️ For a sad day, I recommend our Minute Maid orange juice 🍊. It's bright yellow like sunshine 🌞 and full of vitamin C to perk up your day!", "img/201.gif"], "Any drinks that provide mental and physical stimulation?", 9);
	prescripted_questions[9] = new Question([" I can't understand your question. I am still learning and our programmers are working hard to improve my artificial intelligence technology. Can you type your question again, but in a simpler form? 🥺", "img/200.gif"], "Can you recommend an energy drink?", 10);
...
function typingAnim()
{
    ...
    newNode.setAttribute("class", "chat_message_bot");
    var newImg = document.createElement("img");
    newImg.src = 'img/julia_icon_tmp.jpg';
    newImg.setAttribute("width", "8%");
    newNode.appendChild(newImg);
